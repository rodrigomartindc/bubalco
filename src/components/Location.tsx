...
import { CONTACT, SOCIAL_LINKS, WHATSAPP_URL_GENERAL } from '../data/site';
              ...
              <div className="space-y-3">
                <div className="rounded-2xl border border-gray-200 bg-white p-4 flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500">{CONTACT.address}<br />{CONTACT.location}</p>
                  </div>
                </div>
                <div className="rounded-2xl border border-gray-200 bg-white p-4 flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href={WHATSAPP_URL_GENERAL} target="_blank" rel="noreferrer" className="text-xs text-gray-500 hover:text-gray-900">{CONTACT.phoneVisible}</a>
                  </div>
                </div>
                <div className="rounded-2xl border border-gray-200 bg-white p-4 flex items-start gap-3">
      ...
      <div className="hidden md:block relative z-10 w-full px-6 md:px-12 py-20 max-w-7xl mx-auto">
        <div className={`max-w-3xl ${reveal('animate-fade-in-left')}`}>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-10">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">{CONTACT.address}<br />{CONTACT.location}</p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a href={WHATSAPP_URL_GENERAL} target="_blank" rel="noreferrer" className="text-sm text-gray-500 hover:text-gray-900">{CONTACT.phoneVisible}</a>
              </div>
            </div>
            <div className="flex items-start gap-4">
          ...
          <div className="flex gap-3">
            <a href={SOCIAL_LINKS.instagram} target="_blank" rel="noreferrer" className="w-12 h-12 bg-gray-900 rounded-xl flex items-center justify-center hover:bg-brand transition-colors">
              <Instagram className="text-white" size={20} />
            </a>
            <a href={WHATSAPP_URL_GENERAL} target="_blank" rel="noreferrer" className="w-12 h-12 bg-gray-900 rounded-xl flex items-center justify-center hover:bg-[#25d366] transition-colors">
