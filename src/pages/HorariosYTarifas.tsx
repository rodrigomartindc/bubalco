import { Sun, Moon, Instagram, Phone, MapPin, Heart } from 'lucide-react';
      ...
      <div className="bioparque-slides md:hidden">
        ...
        <section className="bp-slide">
          <div className="bp-card bg-white">
            <div className="px-6 py-8 h-full flex flex-col justify-center text-center">
              <p className="text-xs tracking-widest text-brand uppercase mb-3">Planificá tu visita</p>
              <h1 className="text-2xl font-medium text-gray-900 mb-6">Horarios</h1>

              <div className="bg-brand-dark p-5 rounded-2xl text-white mb-4">
                <div className="flex items-center justify-center gap-2 mb-4">
                  <Sun className="text-white/50" size={16} />
                  <h2 className="text-base font-medium">Jueves a Domingo y Feriados</h2>
                </div>
                <div className="space-y-2">
                  <div className="bg-white/10 p-3 rounded-xl border border-white/10 flex justify-between text-sm">
        ...
        <section className="bp-slide">
          <div className="bp-card bg-brand-dark text-white">
            <div className="px-6 py-8 h-full flex flex-col justify-center text-center">
              <h2 className="text-2xl font-medium text-white mb-6">Tarifas de Ingreso</h2>
              <div className="space-y-3 mb-6">
                {[
                  ...
                  <div key={t.name} className="bg-white/10 p-4 rounded-xl border border-white/10 flex justify-between items-center">
