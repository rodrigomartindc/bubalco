          ...
          <div className="bp-card bg-white">
            <div className="slide-card__scroll px-5 py-6" style={{ textAlign: 'left' }}>
              ...
              <div className="mt-6 bg-gray-50 rounded-xl p-4 border border-gray-100 text-center">
                ...
                <a href={WA_URL} target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 px-5 py-2.5 bg-brand text-white text-sm rounded-full hover:bg-brand-dark transition-colors">
                  Contactanos
                </a>
              </div>
            </div>
      ...
      <div className="hidden md:block pt-[9rem] pb-20 bg-white">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="mt-12 text-center bg-gray-50 rounded-2xl p-8 border border-gray-100">
            ...
            <a href={WA_URL} target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 px-6 py-3 bg-brand text-white text-sm tracking-wide rounded-full hover:bg-brand-dark transition-colors">
