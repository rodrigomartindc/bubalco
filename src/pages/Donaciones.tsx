...
const WA_URL = 'https://api.whatsapp.com/send/?phone=5492984731612&text=%C2%A1Hola%2C+quiero+consultar+sobre+donaciones!&type=phone_number&app_absent=0';
          ...
          <div className="bp-card bg-white">
            <div className="slide-card__scroll px-6 py-8">
              ...
              <p className="text-xs text-gray-400 mt-3 leading-relaxed text-center">
                Enviá el comprobante a <span className="text-gray-600 font-medium">{EMAIL}</span><br />con el asunto "Mi donación".
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-start">
            ...
            <div className="bg-gray-50 rounded-2xl p-8 border border-gray-100">
              ...
              <p className="text-sm text-gray-500 mt-4 leading-relaxed">
                Enviá el comprobante a <span className="font-medium text-gray-700">{EMAIL}</span> con el asunto "Mi donación".
              </p>
            </div>
          </div>
