      ...
      <div className="md:contents">
        ...
        <section className={`${desktopSlide} md:bg-white`}>
          <div className="w-full px-6 md:px-12 lg:px-20 max-w-5xl mx-auto min-h-[calc(100vh-130px)] flex items-center">
            <div className="grid lg:grid-cols-2 w-full overflow-hidden rounded-2xl border border-gray-100 min-h-[min(68vh,520px)]">
              <div className="bg-brand-dark flex flex-col items-center justify-center px-8 py-10 text-center">
                <p className="text-xs tracking-widest text-white/40 uppercase mb-3">Conservación en acción</p>
                <h2 className="text-2xl font-medium text-white mb-3">Un refugio para animales que no pueden volver a la naturaleza</h2>
                <p className="text-sm text-white/60 leading-relaxed max-w-md">
                  En 34 hectáreas de la Patagonia argentina, cuidamos a nuestros habitantes, protegemos a las especies y enseñamos por qué conservar la naturaleza es responsabilidad de todos.
                </p>
              </div>
              <div className="bg-white flex flex-col items-center justify-center px-8 py-10 text-center">
                <h2 className="text-xl font-medium text-gray-900 mb-5 max-w-sm">Un proyecto reconocido por su aporte a la conservación y la educación</h2>
        ...
        {/* Slide 4: De dónde vienen */}
        <section className={`${desktopSlide} md:bg-white`}>
          <div className="w-full px-6 md:px-12 lg:px-20 max-w-3xl mx-auto min-h-[calc(100vh-130px)] flex flex-col justify-center">
            <div className="bg-brand/5 rounded-2xl px-8 py-8 text-center mb-6">
        ...
        <section className={`${desktopSlide} md:bg-white`}>
          <div className="w-full px-6 md:px-12 lg:px-20 max-w-3xl mx-auto min-h-[calc(100vh-130px)] flex flex-col justify-center text-center">
            <p className="text-xs tracking-widest text-brand uppercase mb-3">Nuestra misión</p>
            <h2 className="text-2xl font-medium text-gray-900 mb-5">Convivencia Responsable</h2>
            <div className="space-y-px rounded-2xl overflow-hidden border border-gray-100 text-left">
              {[
                { n: '1', title: 'Educación para generar cambio', desc: 'La educación es un pilar de nuestro trabajo. Compartimos información sobre las especies y la historia de cada animal, porque conocimiento y empatía son la base para un vínculo responsable con la naturaleza.' },
                { n: '2', title: 'Animales que encontraron un hogar', desc: 'Los animales del parque no pueden volver a la naturaleza y están habituados a convivir con personas que respetan su bienestar y los cuidan. Les damos un hogar seguro y nos aseguramos que sus historias no sean en vano.' },
                { n: '3', title: 'Conectar con lo que protegemos', desc: 'Cada vez vivimos más alejados de la naturaleza y es difícil proteger lo que no se conoce. Conectar con cada animal y entender sus desafíos nos impulsa a buscar un mundo en armonía con la naturaleza.' },
              ].map((b) => (
                <div key={b.n} className="px-6 py-4" style={{ background: ['rgba(65,117,88,0.06)', 'rgba(43,89,98,0.06)', 'rgba(65,117,88,0.03)'][Number(b.n) - 1] }}>
        ...
        <section id="tarifas-horarios" className={`${desktopSlide} md:bg-white scroll-mt-[130px]`}>
          <div className="w-full px-6 md:px-12 lg:px-20 max-w-lg mx-auto min-h-[calc(100vh-130px)] flex items-center">
            <div className="w-full overflow-hidden rounded-2xl border border-gray-100">
              ...
              <div className="px-8 py-10 text-center bg-brand-dark">
        ...
        <section className={`${desktopSlide} md:bg-white`}>
          <div className={`w-full px-6 md:px-12 lg:px-20 max-w-lg mx-auto min-h-[calc(100vh-130px)] flex flex-col items-center text-center ${isMapOpen ? 'justify-center py-4' : 'justify-center'}`}>
            {!isMapOpen && (
              <>
                <p className="text-xs tracking-widest text-brand uppercase mb-3">El recorrido</p>
                <h2 className="text-2xl font-medium text-gray-900 mb-5">Mapa del bioparque</h2>
              </>
            )}

            {isMapOpen ? (
              <div className="relative w-full max-h-[min(58vh,480px)] flex items-center justify-center mb-5">
                <button
                  type="button"
                  onClick={() => setIsMapOpen(false)}
                  className="absolute right-0 top-0 z-10 inline-flex h-9 w-9 items-center justify-center rounded-full bg-white/90 text-gray-800 shadow-sm backdrop-blur"
              ...
              <div className="flex flex-col items-center mb-5">
                ...
                >
                  ...
                  <span className="absolute right-2 top-2 inline-flex h-9 w-9 items-center justify-center rounded-full bg-white/90 text-gray-800 shadow-sm backdrop-blur transition-transform group-hover:scale-95">
                    <Search size={17} />
                  </span>
                </button>
                <p className="text-sm text-gray-500 leading-relaxed">
            ...
            <a
              href={asset(MAP_FULL)}
              download="mapa-bubalco-patagonia.jpg"
              className="inline-flex items-center justify-center gap-2 px-8 py-3 bg-brand text-white text-sm rounded-full"
            >
              Descargar mapa
            </a>
          </div>
